  ...
  return (
    <div className="min-h-screen bg-stone-900 text-stone-100">
      ...
      <nav className="sticky top-0 z-20 bg-stone-900/90 backdrop-blur-md border-b border-stone-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 text-sm text-stone-400">
            ...
            <Link href="/games" className="hover:text-stone-100 transition-colors">Interactive</Link>
          </div>
        </div>
      </nav>
      ...
      <header className="max-w-7xl mx-auto px-6 pt-12 pb-10">
        <h1 className="font-[family-name:var(--font-syne)] text-5xl font-extrabold text-stone-100 tracking-tight leading-none mb-3">
          Work
        </h1>
      ...
      <footer className="max-w-7xl mx-auto px-6 py-8 border-t border-stone-800">
